...
public interface MappersStorage {
    ...
    EntityMapper<EmailMessage> EMAIL_MESSAGE_ENTITY_MAPPER = resultSet -> new EmailMessage(resultSet.getInt("email_messages_id"),
    ...
    EntityMapper<Appointment> APPOINTMENT_ENTITY_MAPPER = resultSet -> new Appointment(resultSet.getInt("appointments_id"),
            ...
            new User(resultSet.getInt("customer_id"),
            ...
            new User(resultSet.getInt("master_id"),
    ...
    EntityMapper<Feedback> FEEDBACK_ENTITY_MAPPER = resultSet -> new Feedback(resultSet.getInt("feedbacks_id"),
            new Appointment(resultSet.getInt("appointment_id"),
