...
INSERT INTO `users` VALUES (14,'admin@ukr.net','Admin','Admin','$2a$10$it5GyDjgwDCzSQdvZNzfIOwq1TAm4mf0phWLvZXMFtvTM6.4z5rm.','ROLE_ADMIN','','+380671234567','',''),(15,'user@ukr.net','User','User','$2a$10$dGkGLJal4NnWugv4IYcTkueQEOxAjMbu0U9loOBQuDjTsGueR8zUG','ROLE_USER','','+380671596897','Клієнт',''),(16,'master@ukr.net','Master','Master','$2a$10$w1aZ.IvvQcRCIuFiVv4ooONdgI69KRDbNYUp56idGZUG7LoCcnW7G','ROLE_MASTER','MAKEUP','+380675796428','Майстер',''),(18,'master2@ukr.net','Master2','Master2','$2a$10$w1aZ.IvvQcRCIuFiVv4ooONdgI69KRDbNYUp56idGZUG7LoCcnW7G','ROLE_MASTER','COSMETOLOGY','+380675796428','Другий майстер',''),(23,'user2@ukr.net','user2','user2','$2a$10$4betNKttzhCPxiAudLBNQ.IKpyFGTLp9P6cEwREWuVRa08Ukb300q','ROLE_USER','','+380671234567','',''),(26,'master3@ukr.net','Master3','Master3','$2a$10$QH7Njp5xedE4z/xwl9iXB.MusCuCEkMu6XhFLuJ8bucMsPw6YgwZm','ROLE_MASTER','HAIRDRESSING','+380671234957','',''),(28,'123@ukr.net','123','123','$2a$10$V9SujUodCmu1L2/RFxVuHeMA7hoA8wNPC5Yu0H2YrtWQ.xIkUCZB6','ROLE_MASTER','COSMETOLOGY','+380671234567','',''),(29,'12@15.com','Hi','There','$2a$10$IG3aQQnM3C0oDR77zQQVMetSGdnq1Jn7.vZE.Vogst8bHNnWB6M1a','ROLE_MASTER','MAKEUP','+380671234567','Добре','');
...
-- Dump completed on 2020-02-14 14:43:42
